  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Phishing Investigation", level: "Beginner" },
        { name: "Email Header Analysis", level: "Beginner" },
        { name: "SPF / DKIM / DMARC", level: "Beginner" },
        { name: "Threat Intelligence", level: "Beginner" },
        { name: "IOC Analysis", level: "Beginner" },
        { name: "Digital Forensics", level: "Beginner" },
        { name: "DFIR", level: "Beginner" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "AbuseIPDB", level: "Beginner" },
        { name: "Cisco Talos", level: "Beginner" },
